...
//PropTypes are used to catch a few more bugs before they become a problem. If our data is laid out in a specific way and passed around to components via other components, you can think of PropTypes as a way to ensure the type of data being passed around.--
